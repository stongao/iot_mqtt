##
# Group 8
# This program subscribes the topics "lightSensor", threshold", 
# "LightStatus", "Status/Arduino", and "Status/RaspPi and logs all the 
# messages sent by borker on these topis along with timestamp
#
##
